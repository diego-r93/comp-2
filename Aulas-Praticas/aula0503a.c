 ...
 * $Log: aula0503a.c,v $
 * Revision 1.1  2022/01/16 21:08:11  diego.silva
 * Initial revision
 *
 */
...
int main(int argc, char *argv[])
{
   ...
   for (indice = 1; indice < NUMERO_ARGUMENTOS; indice++)
   {
      ...
      {
         printf("Uso: %s <d1> <d2> ... <d8> <d9>\n", argv[0]);
         printf("Insira digitos entre '0' e '9' ou X para d9.\n");
         exit(ARGUMENTO_INVALIDO);
      }

      if (indice != NUMERO_ARGUMENTOS - 1)
      {
