 ...
 * Descricao: Programa de testes para a funcao CalcularDeterminanteMatriz

 * $Author: diego.silva $
 * $Date: 2022/01/26 11:57:03 $
 * $Log: aula0604.c,v $
 * Revision 1.2  2022/01/26 11:57:03  diego.silva
 * *** empty log message ***
 *
 * Revision 1.1  2022/01/25 08:15:31  diego.silva
 * Initial revision
 *
 */
...
int main(int argc, char *argv[])
{
   ...
   {
      printf("Numero de argumentos invalido\n");
      printf("Uso: %s <ordem da matriz> a11 a12 ... a%u%u\n", argv[0], ordem, ordem);
      exit(NUMERO_ARGUMENTOS_INVALIDO);
   }
   ...
   codigoRetorno = CalcularDeterminanteMatriz(ordem, matrizEntrada, &determinante);
