 ...
 * $Author: diego.silva $
 * $Date: 2022/02/01 06:46:43 $
 * $Log: aula0705.c,v $
 * Revision 1.1  2022/02/01 06:46:43  diego.silva
 * Initial revision
 *
 */
...
int main(int argc, char *argv[])
{
   ...
   if (argc < NUMERO_ARGUMENTOS)
   {
      ...
      printf(" <numero-vertices> <linha-vertice-1> <coluna-vertice-1> <linha-vertice-2> <coluna-vertice-2> . . .");
   ...
   {
      linhasVertices[indice] = strtoul(argv[7 + 2 * indice], &validacao, 10);
      ...
      colunasVertices[indice] = strtoul(argv[8 + 2 * indice], &validacao, 10);
